                    ...
                    <li>
                      <div class="tabla-precio">
                        ...
                        <div class="orden">
                            ...
                            <input type="number" id="pase_dos_dias" min="0" size="3" placeholder="0">
                        </div>
                      </div> <!-- .tabla-precio -->
            ...
            <div class="caja clearfix">
                <div class="extras">
                    <div class="orden">
                        ...
                        <input type="text" id="camisa_evento" min="0" size="3" placeholder="0">
                    </div> <!-- .orden -->
                    <div class="orden">
                        <label for="etiquetas">Paquete de 10 etiquetas de $2 <small>(HTML5, CSS3, JavaScript, Chrome)</small> </label>
                        <input type="text" id="etiquetas" min="0" size="3" placeholder="0">
                    </div> <!-- .orden -->
                    <div class="orden">
